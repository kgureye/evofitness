...
const Benefits = ({ setSelectedPage }: Props) => {
  ...
  <section id="benefits" className="mx-auto min-h-full w-5/6 py-20">
    ...
    >
      ...
      {/* BENEFITS */}
        <motion.div className="mt-5 md:flex items-center justify-between gap-8" initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.5}} variants={container} >
